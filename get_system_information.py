...
Label(root, text='System and Hardware Information',
      font='Verdana 20 bold', fg='#f2bc94', bg="#00154f").pack()
Label(root, text='UNIQUE_CODER', font='Verdana 13 bold',
      fg='#f4af1b', bg="#00154f").pack()
...
def SystemInfo():
    ...
    r = "_____System Information By UNIQUE_CODER _____"
...
def boottime():
    TextBox.delete('1.0', END)
    r = "_____Boot Time Information By UNIQUE_CODER _____"
    TextBox.insert(END, r.center(200))
    TextBox.insert(END, "\n\n\n")
    boot_time_timestamp = psutil.boot_time()
    bt = datetime.fromtimestamp(boot_time_timestamp)
    TextBox.insert(
        END, f"Boot Time: {bt.year}/{bt.month}/{bt.day} {bt.hour}:{bt.minute}:{bt.second}")
...
def CPUInfo():
    TextBox.delete('1.0', END)
    r = "_____CPU Information By UNIQUE_CODER _____"
    TextBox.insert(END, r.center(200))
    TextBox.insert(END, "\n\n\n")
    # number of cores
...
def MemoryInfo():
    TextBox.delete('1.0', END)
    r = "_____Memory Information By UNIQUE_CODER _____"
    TextBox.insert(END, r.center(200))
    TextBox.insert(END, "\n\n\n")
...
def DiskInfo():
    TextBox.delete('1.0', END)
    r = "_____Disk Information By UNIQUE_CODER _____"
    TextBox.insert(END, r.center(200))
    TextBox.insert(END, "\n\n\n")
    ...
    for partition in partitions:
        ...
        try:
            ...
            continue
        TextBox.insert(
            END, f"  Total Size: {get_size(partition_usage.total)} \n")
...
def NetworkInfo():
    TextBox.delete('1.0', END)
    r = "_____Network Information By UNIQUE_CODER _____"
    TextBox.insert(END, r.center(200))
    TextBox.insert(END, "\n\n\n")
    ...
    TextBox.insert(
        END, f"Total Bytes Received: {get_size(net_io.bytes_recv)} \n")
...
def GPUInfo():
    TextBox.delete('1.0', END)
    r = "_____GPU Information By UNIQUE_CODER _____"
    TextBox.insert(END, r.center(200))
    TextBox.insert(END, "\n\n\n")
    gpus = GPUtil.getGPUs()
    for gpu in gpus:
...
Button(root, text='System Information', bg='#f2bc94', fg='#00154f',
       font='Verdana 10 bold', command=SystemInfo).place(x=100, y=130)
Button(root, text='Boot Time', bg='#f2bc94', fg='#00154f',
       font='Verdana 10 bold', command=boottime).place(x=275, y=130)
Button(root, text='CPU Information', bg='#f2bc94', fg='#00154f',
       font='Verdana 10 bold', command=CPUInfo).place(x=380, y=130)
Button(root, text='Memory Information', bg='#f2bc94', fg='#00154f',
       font='Verdana 10 bold', command=MemoryInfo).place(x=525, y=130)
Button(root, text='Disk Information', bg='#f2bc94', fg='#00154f',
       font='Verdana 10 bold', command=DiskInfo).place(x=700, y=130)
Button(root, text='Network Information', bg='#f2bc94', fg='#00154f',
       font='Verdana 10 bold', command=NetworkInfo).place(x=845, y=130)
Button(root, text='Graphic Information', bg='#f2bc94', fg='#00154f',
       font='Verdana 10 bold', command=GPUInfo).place(x=1020, y=130)
# Button(root, text='Follow', bg='#f2bc94', fg='#00154f', font='Verdana 10 bold', width=10, command=Followme).place(x=20, y=280)
Button(root, text='Exit', bg='#f2bc94', fg='#00154f',
       font='Verdana 10 bold', command=exit).place(x=1195, y=130)
